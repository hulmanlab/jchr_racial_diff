...
#%%                     Transform input to the rnn
    ...
    x_test_w = my_utils.get_rnn_input(x_test_w)
    x_test_b = my_utils.get_rnn_input(x_test_b)
    ...
    x_train_tl_w = my_utils.get_rnn_input(x_train_tl_w)
    x_train_tl_b = my_utils.get_rnn_input(x_train_tl_b)
    
    x_val_tl_w = my_utils.get_rnn_input(x_val_tl_w)
    x_val_tl_b = my_utils.get_rnn_input(x_val_tl_b)
    
    x_test_tl_w = my_utils.get_rnn_input(x_test_tl_w)
    x_test_tl_b = my_utils.get_rnn_input(x_test_tl_b)
...
#%%                        Fine-tune the model   
    ...
    history_tl_w = model_tl_w.fit(x_train_tl_w, y_train_tl_w, epochs=100, batch_size=64, validation_data=(x_val_tl_w, y_val_tl_w), callbacks=[early_stop_tl_w])
    ...
    history_tl_b = model_tl_w.fit(x_train_tl_b, y_train_tl_b, epochs=100, batch_size=64, validation_data=(x_val_tl_b, y_val_tl_b), callbacks=[early_stop_tl_b])
