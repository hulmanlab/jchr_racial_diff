...
#%%                     Model and evaluation
    ...
    history = model_base.fit(x_train, y_train, epochs=60, batch_size=64, validation_data=(x_val, y_val), callbacks=[early_stop])
...
#%%                        Fine-tune the model   
    ...
    history_tl = model_tl.fit(x_train_tl, y_train_tl, epochs=60, batch_size=64, validation_data=(x_val_tl, y_val_tl), callbacks=[early_stop_tl])
